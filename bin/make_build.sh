...
ssh -i ../bin/anychart-deploy-key $STATIC_HOST_SSH_STRING "
...
ssh -i ../bin/anychart-deploy-key $STATIC_HOST_SSH_STRING "unzip -q -o /apps/static/cdn/releases/${VERSION}/installation-package.zip -d /apps/static/cdn/releases/${VERSION}/"
